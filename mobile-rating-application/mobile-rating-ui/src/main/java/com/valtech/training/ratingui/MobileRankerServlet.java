...
import com.valtech.training.mobile.ranking.*;
import com.valtech.training.pattern.checker.*;
import com.valtech.training.pattern.checker.PatternChecker.PhoneNumberScore;
...
public class MobileRankerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<PhoneNumberScore> phoneScores = PatternChecker.checkPatterns(phoneNumbers);
